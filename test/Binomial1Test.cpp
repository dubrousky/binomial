...
*/
class Binomial1Test : public CppUnit::TestFixture {
public:
    ...
    //Property tests based on the following cases:
    ...
    CPPUNIT_TEST_SUITE(Binomial1Test);
...
CPPUNIT_TEST_SUITE_REGISTRATION(Binomial1Test);